...
Apart from academic research, I have interned with different teams at Amazon/AWS working on topics in RL Agents and Bandits. Prior to coming to Madison, I completed my Bachelors in Computer Science from [IIT Kanpur](https://cse.iitk.ac.in) where I was fortunate to be advised by [Prof. Piyush Rai](https://www.cse.iitk.ac.in/users/piyush/) and [Prof. Harish Karnick](https://iitk.ac.in/new/dr-harish-karnick).
